...
const imageParagraph = document.querySelector('#imagep');
...
function updateBatteryStatus(battery){
   ...
   var value = (battery.level*100);
   //url sample  "https://robohash.org/YOUR-TEXT.png?set=set4"
  
   const url = `https://robohash.org/${value}.png?set=set4`;
